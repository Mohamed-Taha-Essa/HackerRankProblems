...
A removeDuplicates function is declared in your editor, which takes a pointer to the  node 
...
Note: The  pointer may be null, indicating that the list is empty. Be sure to reset your 
...
class Solution: 
    ...
    def removeDuplicates(self,head):
        ...
        if not head or not head.next:
            return head  # No duplicates in an empty list or a list with one node
        ...
        while current:
            if current.data in seen_values:
                ...
                # Add value to the set to check for duplicates in the future
